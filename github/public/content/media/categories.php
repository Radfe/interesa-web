...
return [
    'proteiny' => [
        'hero' => ['asset' => 'img/cards/proteiny.webp', 'alt' => 'Proteínový shaker a proteínový prášok v čistom štýle'],
        'thumb' => ['asset' => 'img/icons/proteiny.png', 'alt' => 'Ikona kategórie proteíny'],
    ],
    'vyziva' => [
        'hero' => ['asset' => 'img/cards/vyziva.webp', 'alt' => 'Produktový vizuál zdravej výživy na jemnom pozadí'],
        'thumb' => ['asset' => 'img/icons/vyziva.png', 'alt' => 'Ikona kategórie zdravá výživa'],
    ],
    'mineraly' => [
        'hero' => ['asset' => 'img/cards/vitaminy.webp', 'alt' => 'Ilustračný vizuál vitamínov a minerálov'],
